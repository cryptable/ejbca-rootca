...
#########################################################################################
#
#    Copyright 2017 by David Tillemans <david.tillemans@cryptable.org>
#
#    This program is free software: you can redistribute it and/or modify
#    it under the terms of the GNU Lesser General Public License as published by
#    the Free Software Foundation, either version 2 of the License, or
...
#    ln -s ejbca_ce_${EJBCA_VERSION} ejbca
  ...
  cp ejbca-custom/conf/* ejbca/conf/
...
# >>>> NTS-Changes
#ca.tokenpassword=${cakeystorepass}
...
superadmin.dn=CN=\${superadmin.cn},${BASE_DN}
...
cryptotoken.p11.lib.30.file=${pkcs11_lib}
